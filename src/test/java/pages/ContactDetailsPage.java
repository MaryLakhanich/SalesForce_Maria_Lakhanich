...
public class ContactDetailsPage extends BasePage {
    ...
    public Contact getContactInfo() {
        log.info("Getting saved Contact data");
        ...
        Contact.ContactBuilder contactBuilder = Contact.builder().lastName(SplitForStringData.fullNameSplit(fullName)[2]).accountName(SplitForStringData.textSplit(accountName));
        contactBuilder.salutation(Salutation.fromString(SplitForStringData.fullNameSplit(fullName)[0]));
        contactBuilder.firstName(SplitForStringData.fullNameSplit(fullName)[1]);
