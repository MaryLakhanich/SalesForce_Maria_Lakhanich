...
public class InputForAccount extends BaseElement {
    ...
    public void setValueAccount(String value) {
        if (Objects.nonNull(value)) {
            ...
            log.debug(String.format("Setting %s Input locator for Account: %s value = %s", label, INPUT_ACCOUNT_LOCATOR, value));
